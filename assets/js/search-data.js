...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-cfs-ros",
          title: 'cfs-ros',
          description: "A Kinodynamic Motion Planner for ROS",
          section: "Projects",handler: () => {
              window.location.href = "/projects/cfs-ros/";
            },},{id: "projects-fpga-accelerated-signed-distance-field-sdf",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/fpga-sdf/";
            },},{id: "projects-cuda-accelerated-minimum-distance-query",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/min-dist-cuda/";
            },},{id: "projects-nodistort",
          title: 'NoDistort',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/robot-layout-opt/";
            },},{id: "projects-robotsweater",
          title: 'RobotSweater',
          description: "Customizing Textile and Tactile Skins for Interactive Industrial Robots",
          section: "Projects",handler: () => {
              window.location.href = "/projects/robot-sweater/";
            },},{id: "projects-temporal-relation-extraction",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/temporal-relation-extraction/";
            },},{id: "projects-visual-servoing-a-microscope-with-mrac",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/visual-servoing/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%62%6F%62%6F%62%6F%62%6F%73%75@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/bobobobosu", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/bo-su-98300212b", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=G4fyt98AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
